...
<template>
  <div class="auto-repair-container p-6 max-w-6xl mx-auto">
    <div
    ...
    <!-- Filter Controls -->
    <div class="mb-6 flex flex-col sm:flex-row gap-4 pb-5">
      <div class="flex-1">
        <input
          id="search"
          v-model="searchQuery"
            ...
            <div class="mb-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    id="make"
                    v-model="contactForm.vehicle.make"
                    type="text"
                    required
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                    placeholder="Toyota"
                ...
                <div>
                  ...
                  <input
                    id="model"
                    v-model="contactForm.vehicle.model"
                    type="text"
                    required
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                    placeholder="Camry"
                ...
                <div>
                  ...
                  <input
                    id="year"
                    v-model="contactForm.vehicle.year"
                    type="number"
                    required
                    min="1900"
                    :max="currentYear"
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6 text-left">
              ...
              <div class="grid gap-2 text-sm">
                ...
                <div>
                  ...
                  <span class="font-medium ml-1"
                    >{{ contactForm.vehicle.year }}
                    {{ contactForm.vehicle.make }}
                    {{ contactForm.vehicle.model }}</span
                  >
                </div>
              </div>
            </div>
...
const openContactModal = () => {
  ...
  contactForm.value.date = tomorrow.toISOString().split("T")[0];
};
...
const validateForm = () => {
  ...
  // Validate name
  if (contactForm.value.fullName.trim().length < 3) {
...
const submitContactForm = async () => {
  ...
  try {
    ...
    // In a real application, you would send the contact data to your backend
    console.log("Contact form submitted:", {
      ...
      vehicle: contactForm.value.vehicle,
    });
